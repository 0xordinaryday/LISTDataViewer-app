...
public class ParametersHelper {
    ...
    public static ArrayList<LayerType> layerTypes() {
        ...
        layers.add(new LayerType("Infrastructure", "TasWater Sewer Serviced Land", "rings", "0", "SERVICETYPE", "DESCRIPTION", "DATEOFISSUE"));
        layers.add(new LayerType("Infrastructure", "TasWater Water Serviced Land", "rings", "1", "SERVICETYPE", "DESCRIPTION", "DATEOFISSUE"));
        layers.add(new LayerType("Infrastructure", "TasWater Pressure Exclusion Boundary", "rings", "7", "OBJECTID", "DESCRIPTION"));
        ...
        layers.add(new LayerType("NaturalEnvironment", "TASVEG 3.0", "rings", "0", "VEG_GROUP", "VEGCODE", "VEGCODE_D", "PROJECT"));
        layers.add(new LayerType("NaturalEnvironment", "Forest Groups", "rings", "1", "FORGROUP", "OBJECTID", "CURRENCY"));
        layers.add(new LayerType("NaturalEnvironment", "Threatened Native Vegetation 2014",
                "rings", "2", "SCHED_ID", "SCHED_NAME"));
        layers.add(new LayerType("NaturalEnvironment", "Estuarine Catchments", "rings", "4", "EST_CODE", "NAME", "CREATED_ON"));
        layers.add(new LayerType("NaturalEnvironment", "Riverine Catchments", "rings", "5", "RIV_CODE", "NAME", "CREATED_ON"));
        layers.add(new LayerType("NaturalEnvironment", "Geoconservation Sites - Listed", "rings", "63", "NAME", "GEOGRAPHICAL_SIGNIFICANCE", "LISTING_STATUS"));
        layers.add(new LayerType("NaturalEnvironment", "Karst - Integrated Conservation Value", "rings", "55", "KT_NAME", "KT_NSCOR_C", "KT_LTENSEC"));

        layers.add(new LayerType("SearchService", "Address Geocodes", "none", "7", "ADDRESS", "LOCATION", "PROPERTY_NAME", "LOCALITY"));
